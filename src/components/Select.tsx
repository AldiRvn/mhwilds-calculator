  ...
  return (
    <InputContainer label={label} description={description}>
      <div className="relative">
        <select
          className="border-divider bg-input text-primary hover:border-primary focus:border-primary disabled:hover:bg-input/30 disabled:text-placeholder w-full border px-2 py-1.5 font-sans text-sm sm:py-1"
